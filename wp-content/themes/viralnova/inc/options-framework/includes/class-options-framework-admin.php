...
class Options_Framework_Admin {
	...
	function enqueue_admin_styles( $hook ) {
		...
		wp_enqueue_style( 'optionsframework', get_template_directory_uri() . '/inc/options-framework/css/optionsframework.css', array(),  Options_Framework::VERSION );
	...
	function enqueue_admin_scripts( $hook ) {
		...
		wp_enqueue_script( 'options-custom', get_template_directory_uri( ) . '/inc/options-framework/js/options-custom.js', array( 'jquery','wp-color-picker' ), Options_Framework::VERSION );
